package com.zejyej.provider.widget;
...
public class RxDialog extends Dialog {
    ...
    public RxDialog(Context context, boolean cancelable, DialogInterface.OnCancelListener cancelListener) {
