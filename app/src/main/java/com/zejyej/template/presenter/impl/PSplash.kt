...
import com.zejyej.template.presenter.IPSplash
 ...
 * @date 2018/5/2
 */
class PSplash @Inject constructor(): BasePresenter<ISplashView>(), IPSplash {

    @Inject
    lateinit var userService: UserService

    override fun checkLogin(req: LoginReq) {

        userService.login(req)
                .excute(object :BaseObserver<LoginResp>(mView) {
                    ...
                    override fun onNext(t: LoginResp) {
                        ...
                        mView.onCheckLogin(true)
                    }

                    override fun onError(e: Throwable) {
                        super.onError(e)
                        mView.onCheckLogin(false)
                    }
